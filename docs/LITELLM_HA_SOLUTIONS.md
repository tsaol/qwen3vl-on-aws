...
| 对比维度              | 方案A：Docker Compose     | 方案B：Kubernetes      | 方案C：直连 ALB         | 方案D：Router单节点      |
|:---------------------|:------------------------:|:---------------------:|:----------------------:|:----------------------:|
| **架构复杂度**        | ⭐⭐ 简单                  | ⭐⭐⭐⭐ 复杂            | ⭐ 极简                 | ⭐⭐⭐ 中等              |
| **部署时间**          | 30分钟                    | 4-8小时               | 15分钟                  | 20分钟                 |
| **可用性**            | 99.5%                    | 99.9%                 | 99%                    | 95%                    |
| **单点故障**          | ❌ 机器级别               | ✅ 无                  | ✅ 无 (ALB托管)         | ❌ LiteLLM实例         |
| **自动扩容**          | ❌ 手动                   | ✅ 自动                | ❌ 无                   | ❌ 无                  |
| **跨机房**            | ❌ 单机                   | ✅ 支持                | ❌ 单机                 | ❌ 单机                |
| **月度成本**          | $80                      | $500+                 | $85                    | $50                    |
...
|:-----------------------|:-----------:|:-----------:|:-----------:|:-----------:|
| **负载均衡**            | ✅ Nginx    | ✅ K8s      | ✅ ALB      | ✅ 内置      |
| **故障转移**            | ✅ 自动     | ✅ 自动     | ✅ 基础     | ✅ 智能      |
| **健康检查**            | ✅ Docker   | ✅ K8s      | ✅ ALB      | ✅ 内置      |
...
### 方案 C 所需文件：
- AWS ALB + Target Group（通过控制台或 Terraform 配置）
